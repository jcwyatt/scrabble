...
#funtion to read a list of words from a '\n' delimited file
...
score = 0                   #initialise scores to non-zero amount
topScore = 0				
...
#is it long enough (4 letter word or more)
	...
	if status != 'void':
		...
		if score > topScore:
			topScore = score
			topWord = wordToCheck
			print('Current High Score Word: %s \nWhich scores %s\n' % (topWord,topScore))
			

#if no word entered, exit the program
		
print('Thanks for using this app!\n')
print('I got as far as %s' % word)
print('The top score is %s' % topScore)
print('The top word is %s' % topWord)
